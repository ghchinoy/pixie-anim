...
fn bench_nearest_color(c: &mut Criterion) {
    ...
    for i in 0..256 {
        palette.push(Rgb { r: i as u8, g: i as u8, b: i as u8 });
    }
    let pixel = Rgb { r: 128, g: 128, b: 128 };
...
fn bench_zeng_reordering(c: &mut Criterion) {
    ...
    for i in 0..256 {
        ...
        palette_colors.push(Rgb { r: i as u8, g: (i % 64) as u8, b: (255 - i) as u8 });

    }

    let palette = pixie_anim_lib::quant::Palette { colors: palette_colors };
...
fn bench_color_conversions(c: &mut Criterion) {
    ...
    let r = 128u8; let g = 64u8; let b = 200u8;
    ...
    fn bench_planar_lab_simd(c: &mut Criterion) {
        ...
        for i in 0..256 {
            ...
            labs.push(pixie_anim_lib::color::rgb_to_lab(i as u8, (i % 64) as u8, (255 - i) as u8));
        ...
        group.bench_function("Scalar", |b| {
            ...
            b.iter(|| pixie_anim_lib::simd::fallback::find_nearest_color_lab_planar(black_box(pixel), black_box(&palette)))
        ...
        group.bench_function("SIMD (AVX2)", |b| {
            ...
            b.iter(|| pixie_anim_lib::simd::find_nearest_color_lab(black_box(pixel), black_box(&palette)))
    ...
    criterion_group!(benches, bench_nearest_color, bench_zeng_reordering, bench_color_conversions, bench_planar_lab_simd);
