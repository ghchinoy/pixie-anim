    ...
    return html`
      <div class="modal-overlay" @click=${() => this.showHelp = false}>
        <div class="modal" @click=${(e: any) => e.stopPropagation()}>
          ...
          <p><strong>QUALITY:</strong> K-Means iterations. Pixie-Anim 0.1.4+ uses <strong>Weighted Perceptual Sampling</strong> to prioritize vibrant colors and preserve detail in shadows, ensuring high-fidelity color clusters.</p>
